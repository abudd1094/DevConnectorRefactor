...
const AddEducation = ({ addEducation, history }) => {
  ...
  const [toDateDisabled, toggleDisabled] = useState(false); // we don't need the 'to' state field if current is true, so we create a second state to track this
  ...
  return (
    <Fragment>
      ...
      <form className="form" onSubmit={e => {
        ...
        <div className="form-group">
          <h4>To Date</h4>
          {/* to date input is disabled when toDateDisabled state value is true */}
